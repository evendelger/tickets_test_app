...
class CityItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => onSelectDeparturePlace(cityData.city),
      child: Column(
        children: [
          SizedBox(height: 8.h),
          Row(
            children: [
              ...
              Column(
                ...
                children: [
                  Text(cityData.city, style: AppFonts.semibold16.copyWith(color: AppColors.white)),
                  Text('Популярное направление', style: AppFonts.regular14.copyWith(color: AppColors.grey5)),
                ],
              ),
            ],
          ),
