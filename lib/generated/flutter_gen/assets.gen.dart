...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/offers_feed_1.png
  AssetGenImage get offersFeed1 =>
      const AssetGenImage('assets/images/offers_feed_1.png');

  /// File path: assets/images/offers_feed_2.png
  AssetGenImage get offersFeed2 =>
      const AssetGenImage('assets/images/offers_feed_2.png');

  /// File path: assets/images/offers_feed_3.png
  AssetGenImage get offersFeed3 =>
      const AssetGenImage('assets/images/offers_feed_3.png');

  /// File path: assets/images/phuket.png
  AssetGenImage get phuket => const AssetGenImage('assets/images/phuket.png');

  /// File path: assets/images/sochi.png
  AssetGenImage get sochi => const AssetGenImage('assets/images/sochi.png');

  /// File path: assets/images/stambul.png
  AssetGenImage get stambul => const AssetGenImage('assets/images/stambul.png');

  /// List of all assets
  List<AssetGenImage> get values =>
      [offersFeed1, offersFeed2, offersFeed3, phuket, sochi, stambul];
}
